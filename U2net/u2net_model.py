...
optimizer = optim.Adam(model.parameters(), lr=0.002)  # Adam 优化器
...
#训练
train(model,input_data, label, criterion, optimizer,1000,input_data.size(0),2)

# 保存模型
# test(model,input_test,label_test)
test(model,input_test,label_test, criterion,1)

torch.save(model.state_dict(), 'target_allocation_model2.pth')
