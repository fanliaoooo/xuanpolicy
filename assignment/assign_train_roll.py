...
inputs = input_data.reshape(input_data.shape[0],3,-1)
#预处理数据
...
input_valid = input_valid.reshape(input_valid.shape[0],3,-1)
...
input_test = input_test.reshape(input_test.shape[0],3,-1)
...
#训练
train(model,input_data, label, criterion, optimizer,scheduler,500,input_data.size(0),32)
